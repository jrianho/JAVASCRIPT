...
let subtte=parseFloat(prompt("ingrese subsidio de transporte lv 2023")); // 140606
function liquidar(){
    //sueldo basico
    let n1=document.getElementById("salario").value; // bajar info
    let n2=document.getElementById("dias").value;
    Sueldo=parseInt(n1)/30*parseInt(n2);
    document.getElementById("basico").value=Sueldo.toFixed(0); //subir info
    //subsidio trasnsporte
    if (n1>=2*smlv){
        subsidiot=0;
...
// seccion de liquidar de deducciones
//eps y pension
